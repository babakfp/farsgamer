  ...
  <div class="container-base flex items-center justify-between gap-4 h-full lg:gap-0">
    ...
    <div class="flex h-full -ml-2">
      ...
      <button
				...
				class="js-header-search-toggle h-full flex items-center px-2 duration-100 hover:text-brand focus-visible:-translate-y-1 sm:px-2.5 lg:hidden" href="/dashboard" title="مشاهده حساب کاربری"
			>
      ...
      <!-- Go to cart page -->
      <a class="h-full flex items-center px-2 duration-100 hover:text-brand focus-visible:-translate-y-1 sm:px-2.5" href="/cart" title="مشاهده سبد خرید">
        <div class="relative">
      ...
      <a class="h-full flex items-center px-2 duration-100 hover:text-brand focus-visible:-translate-y-1 sm:px-2.5" href="/dashboard" title="مشاهده حساب کاربری">
