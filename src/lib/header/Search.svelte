...
<OutClick on:outclick={close} excludeByQuerySelector={['.js-header-search-toggle']}>
	<form class="hidden {$isOpen && '!block'} absolute h-16 top-full -mt-2 inset-x-4 rounded-sm bg-white border-y border-gray-100 lg:block lg:w-full lg:h-full lg:mt-0 lg:border-l lg:border-t-0 lg:border-b-0 lg:static lg:top-auto lg:inset-x-auto lg:bg-transparent lg:!shadow-none" style="box-shadow: 0 1rem 3rem rgb(0 0 0 / 18%)">
