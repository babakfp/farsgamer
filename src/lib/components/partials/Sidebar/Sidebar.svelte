...
<!-- UnderLay -->
<div id="sidemenu__underlay" class="z-30 fixed inset-0 top-header bg-gray-400/50 duration-300 ease-in-out opacity-0 invisible pointer-events-none {$isOpen && '!opacity-100 !visible !pointer-events-auto'}" />
