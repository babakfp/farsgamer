...
<div class="h-full border-l border-gray-100">
  <button on:click={()=> $isOpen = !$isOpen} class="js-burger-toggle-btn flex items-center justify-center w-header h-header -mr-4 duration-200 active:scale-95" aria-label="{$isOpen ? 'باز کردن' : 'بستن'} منو">
