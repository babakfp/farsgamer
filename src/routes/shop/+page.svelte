...
<div
	class="grid gap-4 mt-8 grid-cols-2 sm:gap-6 sm:grid-cols-3 2md:grid-cols-4 lg:grid-cols-3 2lg:grid-cols-4 xl:grid-cols-5"
>
...
<Pagination
	{currentPageNumber}
	maxNumberOfPage={getPaginationMaxNumberOfPages(products)}
	baseUrl={"/shop"}
/>
