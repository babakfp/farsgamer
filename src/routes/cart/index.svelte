	...
	<Layout>
		...
		<svelte:fragment slot="sidebar">
			...
			<div class="flex text-sm">
				<input class="input pl-6" type="text" placeholder="کد تخفیف">
				<button class="btn btn--brand btn--outline bg-white btn--submit -mr-4">اعمال تخفیف</button>
			</div>
			...
			<ol>
				<li>
					<div class="choose-payment-gateway">
						<input class="hidden" type="radio" id="zarinpal" name="payment-gateway" value="zarinpal">
						<label class="flex items-center gap-2 p-2 border-2 border-gray-200 rounded duration-200 ease-in-out cursor-pointer hover:border-brand" for="zarinpal">
				...
				<li>
					<div class="choose-payment-gateway">
						...
						<label class="flex items-center gap-2 p-2 border-2 border-gray-200 rounded duration-200 ease-in-out cursor-pointer hover:border-brand" for="payir">
