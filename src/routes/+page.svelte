...
<div class="space-y-8 lg:space-y-12">
	...
	{#if $giftCards.length > 0}
		<CardsSection title="گـیفتــکارد ها">
			<Swiper
				class="swiper--card {isGiftCardsSwiperGettingTouched &&
					'swiper--moving'} GiftCardSwiper swiper-prevent-content-shift"
				modules={[Pagination, Autoplay]}
				speed={600}
				grabCursor={true}
				pagination={{}}
	...
	<CardsSection title="نظــرات اخیـر کـاربران">
		<Swiper
			class="swiper--card {isReviewsSwiperGettingTouched &&
				'swiper--moving'} ReviewCardSwiper swiper-prevent-content-shift"
			modules={[Pagination, Autoplay]}
			speed={600}
			grabCursor={true}
			loop={true}
				...
				<SwiperSlide>
					<div class="relative p-4 pb-3 bg-white rounded text-sm">
						<div class="absolute left-2 -top-2 opacity-40">
							<i
								class="icon-quote text-3xl opacity-50 after:absolute after:inset-0 after:h-full after:bg-gradient-to-b after:from-transparent after:to-white"
							/>
						</div>
						...
						<p>
							<span class="block mt-2 text-xs text-gray-500 line-clamp-1"
								>محصولات پابجی موبایل | pubg mobile</span
							>
						</p>
	...
	<section class="grid gap-4 sm:grid-cols-2">
		<a class="block img-hover" href="javascript:">
			<img
				class="w-full rounded aspect-[601/251]"
				src="/img/home/poster-half-width (1).png"
				alt="محصولات کالاف دیوتی موبایل"
				loading="lazy"
			/>
		</a>
		<a class="block img-hover" href="javascript:">
			<img
				class="w-full rounded aspect-[601/251]"
				src="/img/home/poster-half-width (2).png"
				alt="محصولات پابجی موبایل"
				loading="lazy"
			/>
		</a>
	</section>
	...
	<a class="flex img-hover" href="javascript:">
		<img
			class="rounded aspect-[200/41]"
			src="/img/home/poster-full-width (1).png"
			alt="باندل‌های داغ برای فورتنایت باز ها"
			loading="lazy"
		/>
	</a>
	...
	<div class="flex justify-center gap-4">
		<a class="block img-hover" href="javascript:">
			<img
				class="max-w-64 aspect-[2/1] rounded"
				src="/img/home/social-media-telegram.png"
				alt="فارس گیمر در تلگرام"
				loading="lazy"
			/>
		</a>
		<a class="block img-hover" href="javascript:">
			<img
				class="max-w-64 aspect-[2/1] rounded"
				src="/img/home/social-media-instagram.png"
				alt="فارس گیمر در اینستاگرام"
				loading="lazy"
			/>
		</a>
	</div>
	...
	<section class="grid grid-cols-2 gap-4 sm:grid-cols-4 2xl:gap-8">
		{#each posters4 as poster}
			<a class="group | relative block img-hover" href="javascript:">
				<img
					class="aspect-[142/125] rounded 2xl:blur 2xl:brightness-90"
					src={poster.src}
					alt={poster.alt}
					loading="lazy"
				/>
				<img
					class="aspect-[142/125] rounded | hidden absolute inset-center w-2/3 2xl:block | duration-200 group-hover:w-3/4 group-focus-visible:w-3/4"
					src={poster.src}
					loading="lazy"
					aria-hidden="true"
				/>
	...
	<a class="img-hover flex" href="javascript:">
		<img
			class="rounded aspect-[200/41]"
			src="/img/home/poster-full-width (2).png"
			alt="خرید ولورانت پوینت"
			loading="lazy"
		/>
	</a>
</div>
