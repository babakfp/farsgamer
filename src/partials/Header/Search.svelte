...
<OutClick on:outclick={close} excludeByQuerySelector={['.js-mobile-search-toggle']}>
  ...
  ">
      ...
      <button class="absolute left-0 flex items-center justify-center w-14 h-full | p-0 border-0 rounded-none | border-r border-gray-100 hover:bg-gray-100 lg:hidden" on:click|preventDefault={close}>
